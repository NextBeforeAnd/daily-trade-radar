...
- exactly one maritime-chokepoint track was completed, its mandatory direct routes were opened or named as coverage gaps, and its named chokepoint queries were run;
- carrier silence was not used as evidence of no logistics change, incident and publication timestamps remain separate, and reopening negotiations were not presented as operational reopening;
